        ...
        <div className="max-w-7xl mx-auto">
          <div className="container mx-auto px-4 py-2 sm:py-3">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Button asChild className="bg-primary hover:bg-primary/90 w-full sm:w-auto sm:self-center">
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="text-center lg:text-left">
                  <div className="mb-6 ">
                    <div className="text-3xl sm:text-4xl font-bold mb-4 text-primary md:text-5xl">@Doconline24_bot</div>
                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-balance leading-tight">
                      Профессиональный генератор документов с постоянно обновляемой базой шаблонов
                    </h1>
                    <p className="text-base sm:text-lg lg:text-xl text-muted-foreground text-pretty px-2 lg:px-0">
                      Создавайте документы с актуальными шаблонами за 3-5 минут
                    </p>
                  </div>
                  ...
                  <Button
                    size="lg"
                    asChild
                    className="bg-primary hover:bg-primary/90 px-6 py-4 sm:px-8 sm:py-6 w-full sm:w-auto"
                  >
                    <a href="https://t.me/Doconline24_bot" target="_blank" rel="noopener noreferrer">
                      <Send strokeWidth={3} className="mr-2 h-5 w-5 sm:h-6 sm:w-6 text-primary" />
                      <span className="text-base sm:text-lg">Начать создание документа</span>
                  ...
                  <div className="mt-8 grid grid-cols-2 gap-4 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>PDF и Word</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Shield className="h-4 w-4 text-primary" />
                      <span>Актуальные шаблоны</span>
                    </div>
                    <div className="flex items-center space-x-2">
                ...
                {/* Right side - Bot interface mockup */}
                <div className="relative">
                  <div className="absolute -top-4 -left-4 w-24 h-24 bg-purple-500/20 rounded-full blur-2xl animate-pulse-slow" />
                  <div
                    className="absolute -bottom-4 -right-4 w-32 h-32 bg-blue-500/20 rounded-full blur-2xl animate-pulse-slow"
                  ...
                  <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-1 shadow-2xl border border-slate-700/50">
                    <div className="bg-slate-900 rounded-xl overflow-hidden">
                      <div className="bg-slate-800 px-4 py-3 flex items-center space-x-3 border-b border-slate-700/50">
                        <div className="w-3 h-3 bg-red-500 rounded-full" />
                        <div className="w-3 h-3 bg-yellow-500 rounded-full" />
                        <div className="w-3 h-3 bg-green-500 rounded-full" />
                        <div className="flex-1 text-center">
                          <span className="text-sm text-slate-300 font-medium">@Doconline24_bot</span>
                        </div>
                      </div>

                      <div className="relative">
                        <img
                          src="/images/bot-interface.png"
                          alt="Интерфейс Telegram бота @Doconline24_bot для создания юридических документов, договоров, заявлений"
                  ...
                  <div className="absolute -right-6 top-1/4 hidden xl:block">
                    <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-3 text-center animate-float">
                      <div className="text-2xl font-bold text-white">100+</div>
                      <div className="text-xs text-slate-300">Документов создано</div>
                    </div>
                  </div>

                  <div className="absolute -left-6 bottom-1/4 hidden xl:block">
                    <div
                      className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-3 text-center animate-float"
                      style={{ animationDelay: "1s" }}
                    >
                      <div className="text-2xl font-bold text-white">24/7</div>
                      <div className="text-xs text-slate-300">Поддержка</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-base sm:text-lg text-slate-700 dark:text-slate-300 leading-relaxed px-2">
                  ...
                  доверенности, жалобы и другие документы, соответствующие текущему законодательству, всего за 3-5 минут
                  ...
                  {steps.map((step, index) => (
                    <article key={index} className="relative">
                      ...
                      <Card className="border-2 border-blue-200/50 dark:border-blue-800/50 bg-white/90 dark:bg-blue-900/30 backdrop-blur-sm hover:shadow-2xl hover:scale-105 transition-all duration-500 group overflow-hidden h-full">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-900/20 dark:to-teal-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <CardContent className="p-6 sm:p-8 relative z-10">
                          <div className="flex items-start space-x-4">
                            {/* Номер шага */}
                            <div className="flex-shrink-0">
                              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                {step.number}
                              </div>
                            </div>
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                  ...
                  {/* Telegram Group */}
                  <a
                    href="https://t.me/documentonline24bot"
                    target="_blank"
                  ...
                  >
                    <Card className="text-center border-emerald-200/50 dark:border-emerald-800/50 bg-white/90 dark:bg-emerald-900/20 backdrop-blur-sm hover:shadow-2xl hover:scale-105 transition-all duration-300 group overflow-hidden relative h-full">
                      ...
                      <CardContent className="p-6 sm:p-8 relative z-10">
                        ...
                        <h3 className="text-xl font-bold mb-3 text-emerald-900 dark:text-emerald-100">
                          Telegram Группа
                        </h3>
                        <p className="text-sm text-emerald-700 dark:text-emerald-200 mb-6 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="container mx-auto px-4 text-center relative z-10">
            <p className="text-sm sm:text-base text-muted-foreground">
              © 2025 Бот @Doconline24_bot. Все права защищены.
            </p>
          </div>
        </div>
      </footer>
